              ...
              <div className="hero-search">
                <div className="search-container">
                  ...
                  <div className="search-filters-group">
                    <select value={filters.listing_type} onChange={(e) => handleFiltersChange({ listing_type: e.target.value })} className="filter-select">
                    ...
                    <select value={filters.brand} onChange={(e) => handleFiltersChange({ brand: e.target.value })} className="filter-select">
                      <option value="">All Brands</option>
                      {brands.map(b => <option key={b} value={b}>{b}</option>)}
                    </select>
                    
                    <select value={filters.city} onChange={(e) => handleFiltersChange({ city: e.target.value })} className="filter-select">
